...
and a state-of-the-art heuristic solver, LKH3. Regarding heuristics, nearest insertion, random insertion, farthest insertion and nearest neighbor
...
when using AM compared to optimizaiton solvers.
